...
if __name__ == "__main__":
    ...
    simulation(rate=rates, proportion=proportions, simulation_name=args.name, result_repertory=args.output_dir, nb_localities=args.nb_localities, nb_generations=args.nb_generations, nb_max_genus=args.nb_max_genus, nb_max_lineages_in_genus=args.nb_max_lineages)