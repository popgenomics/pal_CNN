...
ggsave(sprintf('%s_count.png',simul_name), width = size_graph, height = size_graph, units = "px", bg='white')
...
for(deme in 0:nb_demes){
  ...
  ggsave(file_name, width = size_graph, height = size_graph, units = "px", bg='white')
}
...
#ggsave(file_name, width = size_graph*6, height = size_graph*3, units = "px", bg='white', limitsize = FALSE)