...
if __name__ == "__main__":
    ...
    parser.add_argument('--demes', '-d', help='Number of localities in simulation', type=int, required=True,
                        action='store')
    ...
    normalize_array(csv_file=args.csv, range_file=args.range, outfile=args.csv_norm, nb_deme=args.demes)
